...
import { createEmployeeAction, uploadEmployeeDocumentAction } from "@/lib/actions/erp-actions";
import { getEmployeeDocuments, getEmployees } from "@/lib/db/live-queries";
import { formatCurrency } from "@/lib/utils";

export default async function HrPage() {
  const [employees, documents] = await Promise.all([getEmployees(), getEmployeeDocuments()]);
  ...
  return (
    <ProtectedShell>
      <div className="space-y-5">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Cargar documento de empleado</CardTitle>
          </CardHeader>
